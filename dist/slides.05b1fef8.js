...
$(function () {
  ...
  var index = 0;
  var picTimer; // create button

  var btn = "<a class='prev'></a><a class='next'></a>";
  $(".slider_box").append(btn); // create navbar pictures

  for (var i = 0; i < len; i++) {
    $imgUrl = $(".silder_panel").eq(i).find("img").attr("src"); // console.log($imgUrl)
...
//# sourceMappingURL=/slides.05b1fef8.map